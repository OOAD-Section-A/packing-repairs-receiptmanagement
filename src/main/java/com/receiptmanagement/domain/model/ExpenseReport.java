...
public final class ExpenseReport {
    ...
    private ExpenseReport(Builder builder) {
        ...
        this.reportId =
                requireText(builder.reportId, "reportId");

        this.employeeId =
                requireText(builder.employeeId, "employeeId");

        this.employeeName =
                requireText(builder.employeeName, "employeeName");

        this.receiptIds =
                new ArrayList<>(
                        builder.receiptIds != null
                                ? builder.receiptIds
                                : List.of()
                );
        ...
        this.currency =
                requireText(builder.currency, "currency");
        ...
        this.status =
                requireText(builder.status, "status");

        this.approverComment =
                builder.approverComment != null
                        ? builder.approverComment
                        : "";
    ...
    public static final class Builder {
        ...
        public Builder receiptIds(
                List<String> receiptIds
        ) {

            this.receiptIds =
                    receiptIds != null
                            ? new ArrayList<>(receiptIds)
                            : new ArrayList<>();

            return this;
        }

        public Builder addReceiptId(
                String receiptId
        ) {
        ...
        public Builder approverComment(
